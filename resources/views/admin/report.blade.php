    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.report.generate') }}" method="post" class="mb-3">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="category" id="category" class="form-control">
                                    ...
                                    <option value="electrical">Electrical/IT</option>
                    ...
                    @if(isset($complaints) && $complaints->count() > 0)
                        ...
                        <script>
                            ...
                            var myPieChart = new Chart(ctx, {
                                type: 'pie',
                                data: {
                                    labels: {!! json_encode($complaints->pluck('status')->unique()) !!},
                                    datasets: [{
                                        data: {!! json_encode($complaints->countBy('status')->values()) !!},
                                        backgroundColor: [
                                            'rgba(97, 245, 195, 0.8)',
                                            'rgba(255, 99, 132, 0.8)',
                                            'rgba(54, 162, 235, 0.8)',
